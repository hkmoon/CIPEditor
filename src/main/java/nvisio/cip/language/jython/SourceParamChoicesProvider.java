...
public class SourceParamChoicesProvider implements ParameterChoicesProvider
{
	...
	/**
	 * The parent {@link JythonCompletionProvider}.
	 */
	...
	public List<Completion> getParameterChoices(JTextComponent tc,
		...
		LanguageSupport support = lsf.getSupportFor(SyntaxConstants.SYNTAX_STYLE_PYTHON);
		...
		JythonParser parser = jls.getParser(textArea);
		if (parser==null) {
			return null;
		}
		...
		if (typeDec instanceof NormalInterfaceDeclaration) {
			// Nothing to do
		}
